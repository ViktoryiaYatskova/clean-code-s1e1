...
var taskInput=document.querySelector(".new-item__task");//Add a new task.
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.classList.add('task__title_completed');
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.classList.remove('task__title_completed');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
