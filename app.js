...
var taskInput=document.getElementById("adding__new-task");//Add a new task.
...
var addTask=function(){
    ...
    //Create a new list item with the text from the #adding__new-task:
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("completed__item_editing");
    ...
    listItem.classList.toggle("completed__item_editing");
};
